...
namespace OnlineShop.Areas.Identity.Pages.Account.Manage
{
    public class ExternalLoginsModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostRemoveLoginAsync(string loginProvider, string providerKey)
        {
            ...
            if (!result.Succeeded)
            {
                StatusMessage = "Đăng nhập bên ngoài không được xóa.";
                return RedirectToPage();
            }

            await _signInManager.RefreshSignInAsync(user);
            StatusMessage = "Đăng nhập bên ngoài đã bị xóa.";
            return RedirectToPage();
        }
        ...
        public async Task<IActionResult> OnGetLinkLoginCallbackAsync()
        {
            ...
            if (!result.Succeeded)
            {
                StatusMessage = "Đăng nhập bên ngoài không được thêm vào. Thông tin đăng nhập bên ngoài chỉ có thể được liên kết với một tài khoản.";
                return RedirectToPage();
            }
